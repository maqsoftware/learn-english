...
public class DemoService2 implements IDemoListener2 {

    private static DemoService2 instance = null;
    private final IMenuScreenListener menuScreenListener;

    public DemoService2(final IMenuScreenListener menuScreenListener) {
        this.menuScreenListener = menuScreenListener;
    }

    public static DemoService2 getInstance(IMenuScreenListener menuScreenListener) {
        if (instance == null) {
            instance = new DemoService2(menuScreenListener);
        }
        return instance;
    }
    ...
    public void onImageBackgroundClick(String screenCode) {
        ...
        }else if (screenCode.equals("DemoScreenLargeNumber")) {
            menuScreenListener.onMathPlaceValueSelected();
        }else if (screenCode.equals("DemoScreenOther")) {
