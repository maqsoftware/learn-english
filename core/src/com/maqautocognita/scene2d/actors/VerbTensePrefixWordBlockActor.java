 ...
 */
public class VerbTensePrefixWordBlockActor extends WordBlockActor {

    public VerbTensePrefixWordBlockActor(String givenWord, final AbstractAutoCognitaScreen screen) {
        super(givenWord);
