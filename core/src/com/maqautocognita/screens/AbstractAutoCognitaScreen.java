...
public abstract class AbstractAutoCognitaScreen implements Screen, AutoCognitaGestureListener {

    public static final String CORRECT_SOUND_AUDIO_FILE_NAMES[] = {"correct1", "correct2", "correct3", "correct4"};
    public static final String WRONG_SOUND_AUDIO_FILE_NAMES[]={"wrong1"};
    ...
    public AbstractAutoCognitaScreen(AbstractGame game, IMenuScreenListener menuScreenListener, String... images) {
        this.game = game;
        this.images = images;
    ...
    public void playWrongSound(final ICorrectSoundListener wrongSoundListener){
        showWrongFrame = true;
        String correctSoundAudioFileName = WRONG_SOUND_AUDIO_FILE_NAMES[0];
    ...
    public String getCorrectSoundFilename()
    {
        return CORRECT_SOUND_AUDIO_FILE_NAMES[RandomUtils.getRandomWithExclusion(0, CORRECT_SOUND_AUDIO_FILE_NAMES.length - 1)];
    }
    ...
    public void render(float delta) {
        ...
        if (isRequiredRender) {
            ...
            if (!isRequiredToWaitImageLoading() || AssetManagerUtils.isFinishLoading()) {
                ...
                else if (showWrongFrame && null != correctBatch) {
                    correctBatch.begin();
                    correctBatch.draw(AssetManagerUtils.getTexture(AssetManagerUtils.WRONG_FRAME), (ScreenUtils.getScreenWidth()/2)-250,(ScreenUtils.getScreenHeight()/2)-250, 500, 500);
                    correctBatch.end();
                }
