 ...
 */
public class AdditionConjugateAcrossTenSection extends AbstractAdditionConjugateSection {
    ...
    private int playingRound = 1;

    public AdditionConjugateAcrossTenSection(MathAudioScriptWithElementCode mathAudioScriptWithElementCode, AbstractAutoCognitaScreen abstractAutoCognitaScreen, IOnHelpListener onHelpListener) {
    ...
    protected void resetScreen() {
        ...
        currentPlayingNumber = getStartNumber();
    ...
    protected int getStartNumber() {
        return playingNumber % 10 == 0 ? 10 : playingNumber % 10;
    }
    ...
    protected float getMovingBlockDestinationXPosition() {
        return startXPositionNumberTrays[getCurrentPlayingNumber() - 1];
    }
