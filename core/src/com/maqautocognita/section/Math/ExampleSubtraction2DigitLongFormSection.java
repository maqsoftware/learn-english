...
/**
 * The app shows {@link #NUMBER_OF_EXAMPLE_REQUIRED_TO_PLAY} examples.  Each is a 2-digit subtraction, where the ones in the top number is greater than or equal to the bottom number.
 * Highlight the ones column, then show the ones answer, then highlight the tens column, then show the tens answer.
 *
 * @author sc.chi csc19840914@gmail.com
 */
public class ExampleSubtraction2DigitLongFormSection extends InstructionSubtraction2DigitLongFormSection
        implements TimerService.ITimerListener {

    private static final int NUMBER_OF_EXAMPLE_REQUIRED_TO_PLAY = 4;

    private final TimerService timerService;

    public ExampleSubtraction2DigitLongFormSection(MathAudioScriptWithElementCode mathAudioScriptWithElementCode, AbstractAutoCognitaScreen abstractAutoCognitaScreen, IOnHelpListener onHelpListener) {
