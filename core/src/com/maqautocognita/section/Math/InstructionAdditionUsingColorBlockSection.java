 ...
 */
public class InstructionAdditionUsingColorBlockSection extends AbstractAdditionUsingColorBlockSection {

    private final int playingLeftValue;

    private final int playingRightValue;

    public InstructionAdditionUsingColorBlockSection(MathAudioScriptWithElementCode mathAudioScriptWithElementCode, int playingLeftValue, int playingRightValue, AbstractAutoCognitaScreen abstractAutoCognitaScreen, IOnHelpListener onHelpListener) {
