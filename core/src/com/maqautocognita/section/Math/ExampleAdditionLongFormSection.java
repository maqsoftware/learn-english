 ...
 */
public class ExampleAdditionLongFormSection extends InstructionAdditionLongFormSection {

    private static final int NUMBER_OF_EXAMPLE_REQUIRED_TO_PLAY = 3;

    public ExampleAdditionLongFormSection(MathAudioScriptWithElementCode mathAudioScriptWithElementCode, int minimumAnswer, int maximumAnswer, AbstractAutoCognitaScreen abstractAutoCognitaScreen, IOnHelpListener onHelpListener) {
    ...
    protected List<String> getHelpAudioFileNameList() {
        Gdx.app.log(getClass().getName(), upperNumber + "+" + lowerNumber);
