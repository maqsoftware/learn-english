 ...
 */
public class PhonicSwahiliListenAndTypeSection extends AbstractSwahiliPhonicKeyboardSection implements IActivityChangeListener {
    ...
    public PhonicSwahiliListenAndTypeSection(AbstractAutoCognitaScreen abstractAutoCognitaScreen, IOnHelpListener onHelpListener) {
    ...
    protected void afterCorrectSoundIsPressed() {
        super.afterCorrectSoundIsPressed();
        initSound();
    }
