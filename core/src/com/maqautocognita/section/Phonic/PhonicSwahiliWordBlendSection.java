 ...
 */
public class PhonicSwahiliWordBlendSection extends AbstractSwahiliPhonicKeyboardSection implements IActivityChangeListener {

    private Activity selectedActivity;

    public PhonicSwahiliWordBlendSection(AbstractAutoCognitaScreen abstractAutoCognitaScreen, IOnHelpListener onHelpListener) {
