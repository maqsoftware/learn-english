package com.maqautocognita.alxp;
...
import com.maqautocognita.R;
import com.maqautocognita.service.ExpansionDownloaderService;
...
public class DownloadExpansionFile extends Activity implements IDownloaderClient {
    ...
    public static final XAPKFile xAPK = new
            ...
            // against
            155500230L // the length of the file in bytes
            )
            ;
    /* expansion service*/
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!expansionFilesDelivered()) {
            ...
            Intent intent = new Intent(vContext, AndroidLauncher.class);
    ...
    private void initializeDownloadUI() {
        ...
        setContentView(R.layout.activity_download_expansion_file);
        ...
        //mPB.getProgressDrawable().setColorFilter(
        //        Color.parseColor("#EEEEEE"), PorterDuff.Mode.LIGHTEN);

        //mPB.getIndeterminateDrawable().setColorFilter(Color.parseColor("#BDBDBD"), PorterDuff.Mode.DARKEN);

        /*mProgressImage.setLayoutParams(new LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT, LinearLayout.LayoutParams.MATCH_PARENT));
        mProgressImage.setScaleType(ImageView.ScaleType.FIT_XY);*/
    ...
    public void onDownloadProgress(DownloadProgressInfo progress) {
        ...
        mProgressFraction.setText(Helpers.getDownloadProgressString
                (progress.mOverallProgress,
                        progress.mOverallTotal));
/*        Integer imageID = (int)(progress.mOverallProgress * 100 / progress.mOverallTotal);

        Bitmap bm;
        switch (imageID){
            case 10:
                bm = getBitmapFromAsset("images/autocognitaloading1.png");
                mProgressImage.setImageBitmap(bm);
                mProgressImage.invalidate();
                break;
            case 20:
                bm = getBitmapFromAsset("images/autocognitaloading2.png");
                mProgressImage.setImageBitmap(bm);
                mProgressImage.invalidate();
                break;
            case 30:
                bm = getBitmapFromAsset("images/autocognitaloading3.png");
                mProgressImage.setImageBitmap(bm);
                mProgressImage.invalidate();
                break;
            case 40:
                bm = getBitmapFromAsset("images/autocognitaloading4.png");
                mProgressImage.setImageBitmap(bm);
                mProgressImage.invalidate();
                break;
            case 50:
                bm = getBitmapFromAsset("images/autocognitaloading5.png");
                mProgressImage.setImageBitmap(bm);
                mProgressImage.invalidate();
                break;
            case 60:
                bm = getBitmapFromAsset("images/autocognitaloading6.png");
                mProgressImage.setImageBitmap(bm);
                mProgressImage.invalidate();
                break;
            case 70:
                bm = getBitmapFromAsset("images/autocognitaloading7.png");
                mProgressImage.setImageBitmap(bm);
                mProgressImage.invalidate();
                break;
            case 80:
                bm = getBitmapFromAsset("images/autocognitaloading8.png");
                mProgressImage.setImageBitmap(bm);
                mProgressImage.invalidate();
                break;
        }
