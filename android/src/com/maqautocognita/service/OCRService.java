            ...
            public void run() {
                ...
                try {
                    ...
                    if (imageFile.exists()) {
                        ...
                        Bitmap pImage = BitmapFactory.decodeFile(imageFile.getAbsolutePath(), options);
                        ocrResult = new OCRResult();
                        ocrResult.imageHeight = options.outHeight;
                        ocrResult.imageWidth = options.outWidth;


                        if (null != actionListener) {
                            actionListener.onComplete(ocrResult);
                        }
                    }
                } catch (Exception e) {
