...
public class AndroidLauncher extends AndroidApplication implements IDeviceService, GoogleApiClient.ConnectionCallbacks,
    ...
    private static final String EXPANSION_FILE_VERSION_KEY_NAME = "001";
    ...
    public class User {
        ...
        public User(String uid, String lastLogin, String token) {
            this.uid = uid;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Max the volume of phone on app startup
        ...
        isTablet = false;
        setScreenOrientationToPortrait();
        game = new AutoCognitaGame(isTablet,21);
    ...
    private void storeUserFirebase() {
        ...
        if (mFirebaseUser != null) {
            ...
            AndroidLauncher.User user = new AndroidLauncher.User(
                    mUid,
                    strDate,
            ...
            // the first time, it inserts user in Firebase db, otherwise it updates it
