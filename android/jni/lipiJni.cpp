...
void JNICALL Java_com_maqautocognita_handWritingRecognition_LipiTKJNIInterface_initializeNative(JNIEnv *env,
																 jobject this_object, 
...
jobjectArray 
	JNICALL Java_com_maqautocognita_handWritingRecognition_LipiTKJNIInterface_recognizeNative(JNIEnv *env,
															   jobject this_object,
															   ...
															   jint NumStrokes)
{
	...
	try
	{
		jclass strokeClass = env->FindClass("com/maqautocognita/handWritingRecognition/Stroke");
		if(strokeClass == NULL)
		...
		jclass resultClass = env->FindClass("com/maqautocognita/handWritingRecognition/LipitkResult");
		if(resultClass == NULL)
